...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 자료형 (data type)
		/*
		 *  1. primitive type (단순 자료형, 원시 자료형) ex. 고정자리, 고정값
		 ...
		 *	  long		8바이트	정수(64비트)	 -992조~ +922조
		 *	  float		4바이트	실수
		 *	 ☆  double	8바이트	실수
		 *
		 *	2. Reference Type(참조자료형) ex. 고정자리, 다른값
		 *		-Array Type : 배열
		...
		System.out.println(str1 == str2); // 바라보는 곳이 다름
		System.out.println(str1 == str3);
		System.out.println(str2 == str3); // 새로 만들라고 해서 다름(메모리에 있지만)
		System.out.println(str2 == str4); // 바라보는 곳이 같음 > str2 에 있음
